...
// interface GeneratedQuoteMap {
//   [key: string]: Quote[];
// }

// const quoteMapData: GeneratedQuoteMap = generateQuoteMap();
// const columns = Object.keys(quoteMapData).reduce((accum, key) => {
//   accum[key] = {
//     id: key,
//     title: key,
//     itemIds: quoteMapData[key].map((item) => item.id),
//   };
//   return accum;
// }, {});

// const items = Object.values(quoteMapData)
//   .flat()
//   .reduce((accum, item) => {
//     accum[item.id] = item;
//     return accum;
...
//   items,
//   columns,
//   columnOrder: Object.keys(quoteMapData),
// };
